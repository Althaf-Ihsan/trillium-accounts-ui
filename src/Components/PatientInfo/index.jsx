  ...
  return (
    <div>
      ...
      >
        ...
        >
          <div className="semibold" style={{ paddingBottom: "24px",fontWeight:"600",fontSize: "16px", }}>
           Patient Information
          </div>
        ...
        <Descriptions layout="vertical" style={{width:"600px"}}>
         {collapsedItems.map((item) => (
                <Descriptions.Item key={item.key} className="custom-description-item" >
                  <div
                    className="semibold"
